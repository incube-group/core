...
namespace InCube.Core.Collections
{
    ...
    public static class Enumerables
    {
        ...
        /// <param name="source">The source enumerable to get the max out of.</param>
        /// <param name="selector">The selector used to obtain a comparable type.</param>
        /// <returns>The min of the <paramref name="source"/>.</returns>
        ...
        /// <summary>
        /// Flattens a collection of <see cref="Maybes"/>'s into an enumerable, effectively removing the None's.
        /// </summary>
        /// <typeparam name="T">The type of the input <see cref="Maybes"/>'s.</typeparam>
        ...
        /// <exception cref="InvalidOperationException">The input sequence contains more than one element.</exception>
        public static Maybe<T> SingleMaybe<T>(this IEnumerable<T> self)
            where T : class
        {
            using IEnumerator<T> enumerator = self.GetEnumerator();
            if (!enumerator.MoveNext())
        ...
        /// <typeparam name="T">The type of the enumerable.</typeparam>
        /// <param name="self">The enumerable to 'go over'.</param>
        /// <param name="provider">Function providing default value.</param>
        ...
        /// <summary>
        /// Checks whether an enumerable is sorted w.r.t. the given <paramref name="comparer"/>.
        /// </summary>
        ...
        {
            return self.Concat(other).GroupBy(keySelector, x => x, (_, group) => @group.First());
        }
