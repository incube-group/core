...
namespace InCube.Core.Functional
{
    ...
    public static class Functions
    {
        ...
        public static TOut ApplyOpt<TIn, TOut>(this TIn self, Func<TIn, Option<TOut>> f) where TIn : TOut => 
        ...
        /// <param name="f">Mapping</param>
        /// <returns>A TOut object</returns>
        public static TOut ApplyOpt<TIn, TOut>(this TIn self, Func<TIn, Maybe<TOut>> f) where TOut : class where TIn : TOut =>
            f(self).GetValueOrDefault(self);
        ...
        /// <param name="f">Mapping</param>
        /// <returns>A T value</returns>
        public static T ApplyOpt<T>(this T self, Func<T, T?> f) where T : class => 
            f(self).GetValueOrDefault(self);
