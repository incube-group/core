...
namespace InCube.Core.Functional
{
    ...
    public interface IInvariantOption<T, TOpt> : IOption<T>, IEquatable<TOpt> where TOpt : IInvariantOption<T, TOpt>
    {
        ...
        /// <returns>True if <see cref="IInvariantOption{T,TOpt}"/> has value and it is equal to the provided element, false otherwise</returns>
        bool Contains(T elem);

        /// <summary>
        /// Checks whether <see cref="IInvariantOption{T,TOpt}"/> has value and value is equal to given element, using provided comparer
        /// </summary>
        /// <param name="elem">The element to compare option value with if it exists</param>
        ...
        /// </summary>
        /// <param name="p">Predicate to check</param>
        /// <returns>An <see cref="IInvariantOption{T,TOpt}"/></returns>
