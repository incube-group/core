...
namespace InCube.Core.Numerics
{
    ...
    public class Histogram<T>
    {
        ...
        public static Histogram<T> Create(IEnumerable<T> values, IReadOnlyList<T> edges, IComparer<T> comparer,
        ...
        private static (int[] Counts, List<int> Indices, int Discarded) GenericHistogram(IEnumerable<T> values,
            int binCount, Func<T, int> binSelector)
        {
